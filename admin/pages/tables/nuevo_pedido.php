...
<html lang="en">
   <head>
      ...
      <title>Nuevo pedido | Sistema de Inventarios</title>
         ...
         <div class="content-wrapper">
            ...
            <section class="content-header">
               <div class="container-fluid">
                  <div class="row mb-2">
                     <div class="col-sm-6">
                        <h1>Registro Nuevo Bodega <?php echo $usuario; ?></h1>
                     </div>
                     <div class="col-sm-6">
               ...
               <div class="container-fluid">
                  ...
                  <div class="card card-default">
                     <div class="card-header">
                        <h3 class="card-title">Formulario Ingreso Nuevo Elemento</h3>
                     ...
                     <div class="card-body">
                        <form method="post" action="procesa_envio.php">
                           <div class="row">
                              <div class="col-md-6">
                              ...
                              <div class="col-md-6">
                                 <div class="form-group">
                                    <label>Codigo </label>
                                    <input type="text" id="cod_envio" name="cod_envio" class="form-control" required>
                                 </div>
                               
                                 <div class="form-group">
                                    <label>Precio </label>
                                    <input type="number" id="total_pedido" name="total_pedido" class="form-control" required>
                                 </div>
